...
def model_data_files():
    """Install every vendored Gazebo model while preserving its layout."""
    data_files = []
...
setup(
    ...
    data_files=[
        ...
        (
            os.path.join('share', package_name, 'meshes/arm'),
            glob(os.path.join('meshes/arm', '*.*')),
        ),
        (
        ...
        (
            os.path.join('share', package_name, 'meshes/gripper'),
            glob(os.path.join('meshes/gripper', '*.*')),
        ),
        (
        ...
        (
            os.path.join('share', package_name, 'meshes/tank'),
            glob(os.path.join('meshes/tank', '*.*')),
        ),
